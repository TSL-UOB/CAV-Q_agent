...
where $w$ is the weight associated with each functional approximation of the state-action pair $\theta(s,a)$. After each episode the current reward and discounted future value represents the temporal difference learning element, $\delta$:
